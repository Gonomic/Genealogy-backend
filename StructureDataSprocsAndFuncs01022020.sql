...
INSERT INTO `testlog` VALUES ('Transaction-9665. Error occured in SPROC: AddChildToParrent(). Rollback executed. Not completed OK (NOK) for parent= 100 and child= 101',27229,'2020-02-01 19:59:41'),('TransAction-9665. TransResult= 0. Start SPROC: AddChildToParent(). Add a child to a parent. Parent= 100. Child= 101',27228,'2020-02-01 19:59:41');
...
-- Dump completed on 2020-02-01 21:08:32
